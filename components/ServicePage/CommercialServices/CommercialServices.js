...
const CommercialServices = () => {
  ...
  const data = {
    ...
    desc1:
      "In today’s competitive maritime landscape, strategic planning and informed decisions are crucial for profitability. Nautilus Shipping offers marine chartering companies and contract management services for ship owners, designed to maximize the value of your fleet. Our seamless operational management services for shipping companies provide expert chartering strategies, market insights, and post-fixture operational support, ensuring you achieve financial success and operational efficiency.",
    desc2:
