    ...
    <>
      <div className="pb-14 px-4">
        <div className="max-w-screen-lg mx-auto w-full flex flex-col gap-7">
          <h2 className="text-4xl sm:text-5xl md:text-7xl font-light leading-tight md:leading-tight tracking-wide text-center sm:text-left">
          ...
          <p className="text-lg md:text-xl font-light w-full sm:w-10/12 text-center sm:text-left tracking-wide">
          ...
          <ul className="list-disc text-base sm:text-lg md:text-xl font-light ps-5 sm:ps-10 md:ps-20 tracking-wide space-y-2">
