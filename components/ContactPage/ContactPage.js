    ...
    <ParallaxProvider>
      ...
      <div className="pt-24 md:pt-28 max-w-screen-lg w-full mx-auto pb-7 sm:pb-14 px-3 md:px-4 space-y-6 sm:space-y-8">
        ...
        <p className="text-base sm:text-lg w-full font-light">
          At <span class="font-bold">Nautilus Shipping</span>, we provide a wide
          range of services designed to optimise your fleet operations and
          ensure long-term success. As one of the trusted{" "}
          <span class="font-bold">ship management companies in India</span>, our
        ...
        <p className="text-base sm:text-lg w-full font-light">
          ...
          <span class="font-bold">technical ship management companies</span> or
          want to learn <br className="hidden md:block" /> more about{" "}
          <span class="font-bold">Nautilus ship management</span> and our global
      ...
      <div className="max-w-screen-lg w-full mx-auto pb-7 sm:pb-14 px-3 md:px-4 space-y-6 sm:space-y-8">
        ...
        <p className="text-base sm:text-lg w-full font-light md:w-11/12">
          Fill out the form with your details and requirements, and a member of
          the <span class="font-bold">Nautilus Maritime Services</span> team
