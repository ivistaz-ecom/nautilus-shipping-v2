            ...
            <div className="flex flex-col flex-1 gap-5 items-end justify-between lg:w-[45%] w-full">
              ...
              <div className="space-y-4 lg:space-y-10 text-left">
                ...
                <p className="text-sm md:text-lg font-light">
                  Naavik Manthan 2025, held on 26th September at the Courtyard
                  by Marriott Mumbai International Airport in partnership with
                  JSW Shipping, brought seafarers and shore teams together for
                  meaningful conversations on the future of shipping.
                  Discussions spanned coastal shipping, operational excellence,
                  AI in shipping, compliance, and crew welfare, highlighting the
