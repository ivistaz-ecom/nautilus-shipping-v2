    ...
    const fetchBlog = async () => {
      ...
      try {
        const res = await fetch(
          `https://docs.nautilusshipping.com/wp-json/wp/v2/posts?_embed&slug=its-not-just-about-the-money-seafarers-need-better-treatment-ifindustry-wants-sea-going-workforce`
        )
