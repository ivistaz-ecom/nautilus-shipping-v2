    ...
    <div className="pt-28 pb-14">
      <div className="max-w-screen-lg mx-auto w-full space-y-7 px-3 md:px-0">
        ...
        <p className="text-center text-base sm:text-xl font-light tracking-wide">
          ...
          <br className="hidden md:block" /> bi-monthly newsletter dives into
          the topics that matter most to the maritime industry and showcases how
          Nautilus is shaping the future of global trade.
        </p>
      </div>
    </div>
  )
