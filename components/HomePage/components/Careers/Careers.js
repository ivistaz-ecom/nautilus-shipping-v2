...
const Careers = () => {
  return (
    <>
      {/* Conditionally render ContainerScroll only on larger screens */}
            ...
            <div className="max-w-screen-xl mx-auto w-full relative flex flex-col sm:flex-row gap-10 px-4">
              <div className="flex flex-col gap-5 w-full sm:w-[536px]">
                ...
                <p className="text-lg sm:text-lg font-light tracking-wide">
                  At Nautilus Shipping, we recognize that our seafarers are the
                  value to our growth. Your expertise and commitment drive our
                  excellence. Set sail with Nautilus Shipping and shape a
                  meaningful career in maritime shipping.
                </p>
      ...
      {/* Render content without animation for mobile */}
