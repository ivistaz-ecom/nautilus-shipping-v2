...
const HeroBanner = () => {
  ...
  return (
    <div className="relative h-[60vh] md:h-screen flex flex-col overflow-hidden">
      ...
      >
        <source
          src="https://ivista-digital-bucket.blr1.cdn.digitaloceanspaces.com/Nautilus-Website/hero-video.webm"
          type="video/mp4"
        />
      </video>
