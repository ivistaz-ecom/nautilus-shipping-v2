...
const For17Years = () => {
  ...
  return (
    <div className="h-auto md:min-h-screen bg-primary py-14 px-4">
      <div className="max-w-screen-xl mx-auto flex flex-col justify-between h-full gap-10">
        <div className="bg-primary md:py-14 px-4 flex flex-col md:items-center">
          {/* Title */}
          ...
          {/* Info Box */}
          <div className="border rounded-xl p-5 sm:p-10 md:p-12 w-full max-w-screen-xl space-y-5 font-light mt-10">
