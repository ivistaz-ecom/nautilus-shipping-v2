...
const Hiring = () => {
  return (
    <div className="max-w-screen-xl mx-auto px-3 sm:px-0 w-full flex flex-col lg:flex-row items-center lg:items-start gap-10 md:gap-16 pb-7 md:pb-14">
      ...
      {/* Text Content */}
      <div className="space-y-4 lg:space-y-5 text-left pt-0 lg:pt-3">
        <h2 className="text-xl md:text-3xl font-light tracking-wider">
          Urgent Requirement
        </h2>
        <p className="text-sm md:text-lg font-light w-full sm:w-9/12">
          We currently seeking a Chief Officer for immediate deployment on our
          fleet of 16 Indian coastal mini bulk carriers. These vessels, built in
          2021, are gearless 8000 DWT and operate exclusively on the Dharamtar –
          Jaigad coastal route (South of Mumbai).
        </p>
        <p className="text-sm md:text-base font-light w-full sm:w-9/12 tracking-wide">
          <strong>Position:</strong> Chief Officer <br />
          ...
          <br />
          Apply now or confirm your readiness by emailing us at{" "}
          <a
